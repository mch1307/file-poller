...
import (
	...
	"github.com/mch1307/file-poll/config"
)
...
func init() {
	...
	config.Conf.LogDir = "."
	logFile = filepath.Join(config.Conf.LogDir, "gomotics.log")
...
func readLogs() (list LogEntries) {
	...
	if err != nil {
		fmt.Println("unable to open log file ", filepath.Join(config.Conf.LogDir, "gomotics.log"), err)
	}
